...
<body>
    ...
    $car = isset($_POST['car']) ? $_POST['car'] : 'No car selected';
    $phone = $_POST['Number'];
    ?>


    <div class="container">
        <h5 class="text-center">Thank You DAFFA_1202204160 for Reserving</h5>
    ...
    <div class="mb-3">
        <div class="d-flex justify-content-center">
            <a href="Daffa_booking.php" class="btn btn-outline-primary w-50">Kembali</a>
        </div>
</body>